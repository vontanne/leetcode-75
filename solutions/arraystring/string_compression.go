...
Time Complexity: O(n)
	...
	- Converting count to string is O(log count) which is bounded

Space Complexity: O(1)
	- Only using pointers and temporary variables
	- Count string is at most 4 characters (max length 2000)
*/
